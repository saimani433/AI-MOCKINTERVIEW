import { ArrowRight, CheckCircle2, Layers3, MessageSquareText, Play, Quote, ScanFace, ShieldCheck, Sparkles, Star, TrendingUp, Zap, Smartphone } from 'lucide-react'
      ...
      <header className="dark-glass fixed left-0 right-0 top-0 z-50 border-b border-white/10">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:h-20 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-7 text-sm font-bold text-white/65 md:flex">
            ...
            <a href="/app-release.apk" download className="flex items-center gap-1.5 text-mint hover:text-mint/80 transition">
        ...
        <section className="noise relative mx-auto grid min-h-[calc(100vh-4rem)] max-w-7xl items-center gap-8 px-3 pb-14 pt-7 sm:min-h-[calc(100vh-6rem)] sm:px-6 sm:pb-20 sm:pt-8 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <a href="/app-release.apk" download className="glass shine-card inline-flex items-center justify-center gap-2 rounded-lg border border-white/15 bg-white/5 px-6 py-4 text-sm font-black text-white hover:bg-white/10 hover:border-white/30 transition shadow-card">
                <Smartphone size={18} className="text-mint animate-pulse" /> Download Android App
              </a>
            </div>
